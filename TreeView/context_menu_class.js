class ContextMenu{
    constructor(){
        ...
        // Add an event listener to detect if user clicks outside the context menu for removal
    ...
    displayMenu(x,y,userObj={}){
        ...
        // Load the content of the menu into the container DIV
        container.innerHTML = temp_str;

        // Position and display the menu (5 x 5 pixels south-east of mouse position)
