class TreeView{
    ...
    drawTree(){
        ...
        let previous_uid = "undefined-undefined";
        ...
        for(let i=0; i < this.list.length; i++){
            ...
            if(expansion_list.slice(-1)=="show"){
                ...
                if(branch.type == 'root'){
                    tempstr = tempstr.replace("$branch_type",this.folder_icon)
                }
                else
                    tempstr = tempstr.replace("$branch_type",this.document_icon);
                ...
                // Calculate branch indent based on branch level
                let margin = "0px 0px 0px " + (branch.level*40).toString() +"px";
                ...
                if(branch.selected== true){
                    let el = document.getElementById(branch.uid);
